// Landing page — hero section with CTAs and feature callouts, wrapped in the animated aurora background
...
/**
 * Ghost chart SVG path — a decorative stock-chart line drawn at the bottom of
 * the viewport. It's purely cosmetic; opacity is ~3.5% so it reads as texture.
 */
...
/** Feature card data — rendered as a 3-column grid below the hero */
const features = [
  {
    icon: (
...
/**
 * LandingPage — public-facing marketing page shown to unauthenticated visitors.
 *
 * Layers (bottom to top):
 *   1. AuroraBackground — animated cream/teal blobs in fixed position
 *   2. Fixed overlay div — radial gradient glow + ghost chart SVG + grid texture
 *   3. Hero <main> — logo badge, headline, tagline, CTA buttons, stat pills
 *   4. Features <section> — three card grid explaining the app's modes
 */
export default function LandingPage() {
  return (
    <AuroraBackground className="min-h-screen overflow-hidden block">
      {/* Background overlays — fixed so they don't scroll with content */}
      <div className="fixed inset-0 pointer-events-none">
        {/* Warm radial glow centered on the hero */}
        ...
        />
        {/* Ghost chart — decorative S-curve that reads as a stock price line */}
        ...
        {/* Subtle grid texture — 64px cells, barely visible at 1.2% opacity */}
      ...
      <main className="relative flex flex-col items-center text-center px-6 pt-28 pb-20">
        ...
        {/* "Live market data" pill badge with a pulsing dot */}
        ...
        {/* Headline — split across two lines so the words stay balanced at all viewport widths */}
        ...
        {/* Quick-glance stats: stock pool size, picks per player, game duration options */}
      ...
      {/* Feature cards — each describes one core mode of the app */}
